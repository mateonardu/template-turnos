...
export default function BotonWhatsApp() {
  ...
  // Se esconde mientras el wizard de turnos está en pantalla,
  // para no competir con el flujo de reserva.
  useEffect(() => {
  ...
  return (
    <a
      ...
      tabIndex={oculto ? -1 : 0}
      className={`fixed right-4 bottom-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] shadow-lg transition-opacity hover:opacity-90 ${
